...
return [
    ...
    'App' => [
        ...
        'defaultTimezone' => env('APP_DEFAULT_TIMEZONE', 'America/Brasil'),
        'base' => false,
        'dir' => 'src',
        'webroot' => 'webroot',
        'wwwRoot' => WWW_ROOT,
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '8kpsiy9x3kww1ffjxxs607pk00gsbzea9utiis5c4qyuw45jqnghlwrcmzun'),
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => ['email@server.com.br' => 'Sistema Financeiro'],
            'charset' => 'utf-8',
            'headerCharset' => 'utf-8'
        ],
    ],
