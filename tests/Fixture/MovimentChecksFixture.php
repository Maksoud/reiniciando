...
/**
 * MovimentChecksFixture
 *
 */
class MovimentChecksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'moviments_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'transfers_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'coins_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'caixaforn' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'cheque' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'parameters_id' => 1,
            'ordem' => 1,
            'created' => '2017-02-24 18:31:12',
            'modified' => '2017-02-24 18:31:12',
            'banks_id' => 1,
            'boxes_id' => 1,
            'costs_id' => 1,
            'event_types_id' => 1,
            ...
            'transfers_id' => 1,
            'coins_id' => 1,
            'caixaforn' => 'Lorem ipsum dolor sit ame',
