...
/**
 * SupportContactsFixture
 *
 */
class SupportContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'numero_caso' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'parameters_id' => 1,
            'created' => '2017-06-23 13:15:08',
            'modified' => '2017-06-23 13:15:08',
