...
/**
 * MovimentBoxesFixture
 *
 */
class MovimentBoxesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'moviment_checks_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'vencimento' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'valorbaixa' => ['type' => 'decimal', 'length' => 20, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'parameters_id' => 1,
            'ordem' => 1,
            'created' => '2017-02-24 18:31:01',
            'modified' => '2017-02-24 18:31:01',
            'boxes_id' => 1,
            'costs_id' => 1,
            'document_types_id' => 1,
            'event_types_id' => 1,
            'moviment_checks_id' => 1,
            'transfers_id' => 1,
            'moviments_id' => 1,
            'account_plans_id' => 1,
            'coins_id' => 1,
