...
class TransfersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'banks_dest' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'boxes_dest' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'costs_dest' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'account_plans_dest' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'data' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'programacao' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'radio_origem' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'radio_destino' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'cheque' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nominal' => ['type' => 'string', 'length' => 120, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'contabil' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'parameters_id' => 1,
            'ordem' => 1,
            'created' => '2017-02-24 18:32:12',
            'modified' => '2017-02-24 18:32:12',
            'banks_id' => 1,
            'boxes_id' => 1,
            'costs_id' => 1,
            'coins_id' => 1,
            ...
            'boxes_dest' => 1,
            'costs_dest' => 1,
            'account_plans_dest' => 1,
            'data' => '2017-02-24',
            'programacao' => '2017-02-24',
            'radio_origem' => 'Lorem ipsum dolor ',
            'radio_destino' => 'Lorem ipsum dolor ',
            'valor' => 1.5,
            'documento' => 'Lorem ipsum dolor sit amet',
            'historico' => 'Lorem ipsum dolor sit amet',
            'emissaoch' => '2017-02-24',
            'cheque' => 'Lorem ipsum dolor ',
