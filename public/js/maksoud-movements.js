...
(function($) {
    $(document).ready(function($) {
        ...
        $("#informarCard").on("click", function() {
            ...
            if ($("#collapsePagamento").is(":hidden")) {
                ...
                if (wasHidden) {
                    ...
                    formAction = formAction.replace("movements", "movement-cards");
                    ...
                    //$("form").attr("action", "/movement-cards/add?titulo=Novo+Movimento+de+Cart%C3%A3o");
                    ...
                    formAction = formAction.replace("movement-cards", "movements");
                    formAction = formAction.replace("add?titulo=Novo+Movimento+de+Cart%C3%A3o", "add?titulo=Nova+Conta+a+Pagar%2FReceber");
                    $("#cprCardsForm").attr("action", formAction);
                    //$("form").attr("action", "/movements/add?titulo=Nova+Conta+a+Pagar%2FReceber");
        ...
        //controle de cálculo de descontos na tela de Movements/LOW
