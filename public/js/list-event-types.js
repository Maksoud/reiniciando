...
(function ($) {
    $(document).ready(function ($) {
        ...
        var context = $('#logo').attr('data-url'),
                url = context + 'event-types/json/';

        ////////////////////////////////////////////////////////////////////////

        var title        = $('#event_types_title'),
            eventTypesId = $('#event_types_id');
        var eventTypesloading = $('.loadingEvents');
        ...
        title.bind('typeahead:select', function (ev, selected) {
            ...
            if (selected) {
                ...
                eventTypesId.val(selected.id);
            }
            eventTypesloading.html(''); 
        });
        ...
        title.bind('typeahead:asyncrequest', function (ev, suggestion) {
            eventTypesloading.html('<i class="fa fa-spinner fa-pulse fa-3x fa-fw" style="font-size:18px;"></i>');
        });
