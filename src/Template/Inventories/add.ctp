...
/* Inventories */
/* File: src/Template/Inventories/add.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create('inventory', ['type' => 'file', 'class' => 'ajax_add', 'data-url' => 'inventories/addjson']) ?>
            ...
            <div class="<?= $double ?> well" style="min-height: 125px;">
                <div class="row top-10">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('code', ['label' => false, 'type' => 'text', 'maxlength' => '11', 'class' => $input, 'value' => str_pad($code, 6, '0', STR_PAD_LEFT), 'disabled' => true]) ?>
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                ...
                <table id="products-table" class="table table-hover table-bordered table-condensed table-striped" style="margin-bottom: -1px;">
                    <thead class="bg-gray">
                        <tr style="font-size: 12px;">
                            ...
                            <th rowspan="2" class="text-center col-xs-1" style="vertical-align: middle;"><?= __('Ações') ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- CONTENT -->
