...
/* Pages */
/* File: src/Template/Pages/recupera_senha.ctp */
?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 semPadding ">
                    ...
                    <div class="row">
                        <div class="col-xs-12 bottom-10 top-20">
                            <div class="row">
                                <div class="col-xs-12">
                                    <label class="control-label text-nowrap"><?= __('Nova Senha') ?></label>
                                    <?= $this->Form->control('password', ['label' => false, 'type' => 'password', 'class' => 'form-control form-group width-x317', 'placeholder' => 'Senha', 'div' => ['class' => 'input-group'], 'after' => '<span class="add-on input-group-addon"><i class="fa fa-eye"></i></span>', 'required' => true]) ?>
                                </div>
                            </div>
