...
/* Providers */
/* File: src/Template/Providers/add.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create('provider', ['type' => 'file', 'class' => 'ajax_add', 'data-url' => 'providers/addjson']) ?>
                ...
                <div class="<?= $double ?>">
                    <div class="row">
                        <div class="<?= $double ?>">
                            ...
                            <?= $this->Form->control('tipo', ['label' => false, 'type' => 'select', 'class' => $input.' focus tipocpfcnpj', 'options' => ['J' => __('Pessoa Jurídica'), 'F' => __('Pessoa Física')]]) ?>
                        </div>
                        <div class="<?= $double ?>">
