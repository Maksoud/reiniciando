...
<div class="col-xs-12 col-md-12 col-sm-12 container top-20">
    ...
    <div class="col-xs-12 panel" style="float: none;">
        <div class="pull-right"><?= $this->Html->link(__(' Incluir'), ['controller' => 'Cards', 'action' => 'add'], ['class' => 'btn btn-primary fa fa-plus-circle top-20 right-10 btn_modal', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Novo Cartão'), 'data-size' => 'sm', 'escape' => false]) ?></div>
                ...
                <?php foreach ($cards as $card): ?>
                    <tr>
                        ...
                        <td class="btn-actions-group">
                            <?= $this->Html->link('', ['action' => 'view', $card->id], ['class' => 'btn btn-actions btn_modal fa fa-eye', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Dados do Cadastro'), 'data-size' => 'sm', 'title' => __('Visualizar'), 'escape' => false]) ?>
                            ...
                            <?= $this->Html->link('', ['action' => 'edit', $card->id], ['class' => 'btn btn-actions btn_modal fa fa-pencil', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Editar Cadastro'), 'data-size' => 'sm', 'title' => __('Editar'), 'escape' => false]) ?>
