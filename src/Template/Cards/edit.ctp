            ...
            <div class="<?= $single ?> well">
                ...
                <div class="row">
                    <div class="<?= $single ?>">
                        ...
                        <?= $this->Form->control('limite', ['label' => false, 'type' => 'text', 'type' => 'text', 'value' => $this->MyForm->decimal($card->limite), 'class' => $input.' valuemask', 'placeholder' => __('0,00'), 'disabled' => true]) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $single ?>">
