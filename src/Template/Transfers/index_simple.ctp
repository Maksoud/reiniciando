...
/* Transfers */
/* File: src/Template/Transfers/index_simple.ctp */
?>

<div class="col-xs-12 col-md-12 col-sm-12 container top-20">
    
    <div class="col-xs-12 panel" style="float: none;">
        <div class="pull-right"><?= $this->Html->link(__(' Incluir'), ['controller' => 'Transfers', 'action' => 'add_simple'], ['class' => 'btn btn-primary fa fa-plus-circle top-20 right-10 btn_modal', 'data-loading-text' => __('Carregando...'), 'data-title' => 'Nova Transferência', 'escape' => false]) ?></div>
            ...
            <tbody>
                <?php foreach ($transfers as $transfer): ?>
                    <tr class="initialism">
                        ...
                        <td class="text-left">
                            <?= $transfer->has('banks_id') ? $this->Html->link('MB'.str_pad($transfer->MovimentBanks['ordem'], 4, '0', STR_PAD_LEFT), ['controller' => 'MovimentBanks', 'action' => 'view_simple', $transfer->MovimentBanks['id']], ['class' => 'btn_modal label label-primary', 'data-title' => 'Visualizar Lançamento de Movimento de Banco']) : ''; ?>
                            <?= $transfer->has('boxes_id') ? $this->Html->link('MC'.str_pad($transfer->MovimentBoxes['ordem'], 4, '0', STR_PAD_LEFT), ['controller' => 'MovimentBoxes', 'action' => 'view_simple', $transfer->MovimentBoxes['id']], ['class' => 'btn_modal label label-primary', 'data-title' => 'Visualizar Lançamento de Movimento de Carteira']) : ''; ?>
                        </td>
                        <td class="text-left">
                        ...
                        <td class="text-left">
                            <?= $transfer->has('banks_dest') ? $this->Html->link('MB'.str_pad($transfer->MovimentBanksDest['ordem'], 4, '0', STR_PAD_LEFT), ['controller' => 'MovimentBanks', 'action' => 'view_simple', $transfer->MovimentBanksDest['id']], ['class' => 'btn_modal label label-primary', 'data-title' => 'Visualizar Lançamento de Movimento de Banco']) : ''; ?>
                            <?= $transfer->has('boxes_dest') ? $this->Html->link('MC'.str_pad($transfer->MovimentBoxesDest['ordem'], 4, '0', STR_PAD_LEFT), ['controller' => 'MovimentBoxes', 'action' => 'view_simple', $transfer->MovimentBoxesDest['id']], ['class' => 'btn_modal label label-primary', 'data-title' => 'Visualizar Lançamento de Movimento de Carteira']) : ''; ?>
                        </td>
                        <td class="text-left">
                        ...
                        <td class="btn-actions-group">
                            <?= $this->Html->link('', ['action' => 'view_simple', $transfer->id], ['class' => 'btn btn-actions btn_modal fa fa-eye', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Dados do Cadastro'), 'title' => __('Visualizar'), 'escape' => false]) ?>
                            <?php if ($transfer->status == 'P') { ?>
                                ...
                                <?= $this->Html->link('', ['action' => 'edit_simple', $transfer->id], ['class' => 'btn btn-actions btn_modal fa fa-pencil', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Editar Cadastro'), 'title' => __('Editar'), 'escape' => false]) ?>
                            <?php } else { ?>
                                <?= $this->Html->link('', ['action' => 'edit_baixado_simple', $transfer->id], ['class' => 'btn btn-actions btn_modal fa fa-pencil', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Editar Cadastro'), 'title' => __('Editar'), 'escape' => false]) ?>
    ...
    <div class="panel-heading" style="font-size: 11px;">
        ...
        <span style="color: #2aabd2"><?= __('Tipos de Vínculos: MB: Movimentos de Bancos; MC: Movimentos de Carteiras.') ?></span><br />
