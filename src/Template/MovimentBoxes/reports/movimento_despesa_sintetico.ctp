...
<div class="col-xs-12 main">
    ...
    <h4 class="page-header text-bold"><?= __('MOVIMENTOS DE CAIXAS - DESPESAS - SINTÉTICO') ?></h4>
    ...
    if (empty($movimentBoxes)) {
        ...
        $somatitulostotal = $somadesctotal = $somadebitototal = $saldototal = 0;
                ...
                <table class="table table-striped table-condensed prt-report">
                    <thead>
                        <tr class="bg-blue">
                            ...
                            <th class="text-center text-nowrap col-xs-1"><?= __('Saldo') ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php 
                        ...
                        if (!empty($dtbaixa)) {
                            foreach (array_unique($dtbaixa) as $index => $value):
                                ...
                                <tr>
                                    ...
                                    <td class="text-right text-nowrap col-xs-1"><?= $this->Number->currency($debitob, 'BRL');    $saldo += $debitob; $somadebito += $debitob;  ?></td>
