...
<div class="col-xs-12 main">
    ...
    <h4 class="page-header text-bold"><?= __('MOVIMENTOS DE CAIXA - FLUXO DIÁRIO - SINTÉTICO') ?></h4>
                                    ...
                                    foreach (array_unique($baixa) as $index => $value):
                                        ...
                                        <tr>
                                            ...
                                            foreach ($movimentBoxes as $value):
                                                if ($value['dtbaixa'] == $dtbaixa[$index] && $value['boxes_id'] == $boxesid[$box]) {
