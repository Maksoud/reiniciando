...
/* MovimentBoxes */
/* File: src/Template/MovimentBoxes/edit_simple.ctp */
?>
                ...
                <div class="row">
                    <div class="<?= $single ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input id="costs_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o nome da categoria ou adicione') ?>" value="<?= $movimentBox->Costs['title']; ?>"><div class="loadingCosts"></div>
                        </div>
                        <input name="costs_id" id="costs_id" type="hidden" value="<?= $movimentBox->costs_id; ?>">
                    </div>
                </div>
            ...
            <div class="<?= $single ?>">
                ...
                <div class="row">
                    ...
                    <div class="<?= $double ?> well" style="min-height: 204px;">
                        <div class="row top-10" style="margin-bottom: -10px;">
                            <div class="<?= $single ?>">
                                <label class="<?= $label ?>">
                                    <?= __('Carteira') ?>
