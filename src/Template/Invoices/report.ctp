...
/* Report */
/* File: src/Template/Purchases/report.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create('Purchase', ['target' => '_blank']) ?>
            ...
            <div class="<?= $double ?> well" style="min-height: 227px;">
                ...
                <div class="row">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('Ordem', ['label' => false, 'type' => 'select', 'class' => $input, 'options' => ['dtemissaonf' => __('Data da Emissão da NF'),
                                                                                                                                  'nf'          => __('Nota Fiscal'),
                                                                                                                                  'type'        => __('Tipo de Faturamento'),
                                                                                                                                  'status'      => __('Status')
                                                                                                                                 ],
                                                            'default' => 'dtemissaonf'
                                                          ]
                    ...
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('status', ['label' => false, 'type' => 'select', 'class' => $input, 'options' => ['P' => __('Em Entrega'),
                                                                                                                                   'F' => __('Finalizado'),
                                                                                                                                   'C' => __('Cancelado')
                ...
                <div class="row">
                    <div class="<?= $single ?>">
                        <script type="text/javascript">
                            $(document).ready(function() {
                                $('#providers').multiselect({
                                    ...
                                    nonSelectedText: 'Lista de Fornecedores',
                        ...
                        <label class="<?= $label ?>" style="font-weight: normal">
                            <?= __('Fornecedores') ?>
                            <i class="fa fa-info-circle" data-toggle="tooltip" title="<?= __('É possível filtrar os fornecedores.') ?>"></i>
                        </label>
                        <?= $this->Form->control('providers_id', ['label' => false, 'type' => 'select', 'id' => 'providers', 'class' => $input, 'empty' => false, 'options' => $providers, 'multiple' => 'multiple']) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $single ?>">
