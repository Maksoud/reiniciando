...
/* MovimentBanks */
/* File: src/Template/MovimentBanks/add.ctp */
?>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="<?= $double ?> well" style="min-height: 247px;">
                ...
                <div class="row box text-center" style="padding-top: 0px; padding-bottom: 0px; display: block; margin: auto; margin-bottom: 19px; width: 210px; margin-top: 15px; margin-bottom: 4px;">
