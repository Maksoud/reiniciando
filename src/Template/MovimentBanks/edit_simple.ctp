...
/* MovimentBanks */
/* File: src/Template/MovimentBanks/edit_simple.ctp */
?>
                ...
                <div class="row">
                    <div class="<?= $single ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input id="costs_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o nome da categoria ou adicione') ?>" value="<?= $movimentBank->Costs['title']; ?>"><div class="loadingCosts"></div>
                        </div>
                        <input name="costs_id" id="costs_id" type="hidden" value="<?= $movimentBank->costs_id; ?>">
                    </div>
                </div>
