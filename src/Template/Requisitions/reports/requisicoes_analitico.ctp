...
<div class="col-xs-12 main bottom-50">
    ...
    <h3 class="page-header"><span class="text-bold"><?= __('REQUISIÇÕES - ANALÍTICO') ?></span></h3>
    <div class="pull-4 bottom-20">
        <?= $this->element('report-filter-requisitions'); ?>
    </div>
                ...
                <table class="table table-striped table-condensed prt-report">
                    <thead>
                        <tr class="bg-blue">
                            ...
                            <th class="text-center width-r100 text-nowrap"><?= __('OF') ?></th>
                            <th class="text-center width-r100 text-nowrap"><?= __('Data OF') ?></th>
                            <th class="text-center width-r100 text-nowrap"><?= __('Status OF') ?></th>
                            ...
                            <th class="text-center width-r200 text-nowrap"><?= __('Data do Pedido') ?></th>
                            ...
                            <th class="text-center width-r200 text-nowrap"><?= __('Status do Pedido') ?></th>
                    ...
                    <tbody>
                        ...
                        foreach ($requisitions as $value): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <?= $value->type ? $this->Requisitions->type($value->type) : '-' ?>
                                </td>
                                <td class="text-left">
                                ...
                                <td class="text-center">
                                    <?= $value->Industrializations['status'] ? $this->Industrializations->status($value->Industrializations['status']) : '-' ?>
                                </td>
                                <td class="text-left">
                                ...
                                <td class="text-center">
                                    <?= $value->Sells['date'] ? date("d/m/Y", strtotime($value->Sells['date'])) : '-' ?>
                                </td>
                                <td class="text-center">
                                    <?= $value->Sells['shipment'] ? date("d/m/Y", strtotime($value->Sells['shipment'])) : '-' ?>
                                </td>
                                <td class="text-center">
