...
/* Requisitions */
/* File: src/Template/Requisitions/edit.ctp */
?>
                        ...
                        foreach ($requisitionItems as $requisitionItem): ?>
                            <tr style="font-size: 11px;">
                                <td colspan="4" class="text-nowrap" style="vertical-align:middle !important;">
                                    <input type="hidden" name="ProductList[<?= $idx ?>][products_id]" id="list_id_product" value="<?= $requisitionItem->products_id ?>">
                                    <input type="hidden" name="ProductList[<?= $idx ?>][products_title]" id="list_product" value="<?= $requisitionItem->Products['title'] ?>">
                                    <?= $requisitionItem->products_id ?> - <?= $requisitionItem->Products['title'] ?>
                                </td>
                                <td class="text-center" style="vertical-align:middle !important;">
                                    <input type="hidden" name="ProductList[<?= $idx ?>][unity]" id="list_unity" value="<?= $requisitionItem->unity ?>">
                                    <?= $requisitionItem->unity ?>
                                </td>
                                <td class="text-center" style="vertical-align:middle !important;">
                                    <input type="hidden" name="ProductList[<?= $idx ?>][quantity]" id="list_quantity" value="<?= $this->Number->format($requisitionItem->quantity, ['places' => 4, 'locale' => 'en_US']) ?>">
                                    <?= $this->Number->precision($requisitionItem->quantity, 4) ?>
                                </td>
