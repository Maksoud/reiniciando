...
/* Transporters */
/* File: src/Template/Transporters/add.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create('transporter', ['type' => 'file', 'class' => 'ajax_add', 'data-url' => 'transporters/addjson']) ?>
        ...
        <div class="row">
            <div class="<?= $single ?> box">
                <div class="<?= $double ?>">
                    <div class="row">
                        <div class="<?= $double ?>">
                            ...
                            <?= $this->Form->control('type', ['label' => false, 'type' => 'select', 'class' => $input.' focus tipocpfcnpj', 'options' => ['J' => __('Pessoa Jurídica'), 'F' => __('Pessoa Física')]]) ?>
                        </div>
                        <div class="<?= $double ?>">
                            <label class="<?= $label ?>"><?= __('CPF/CNPJ') ?></label>
                            <?= $this->Form->control('cpfcnpj', ['label' => false, 'type' => 'text', 'class' => $input.' cpfcnpjmask validacpfcnpj', 'maxlength' => '25', 'required' => true]) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="<?= $double ?>">
                            <label class="<?= $label ?>"><?= __('Insc. Municipal') ?></label>
                            <?= $this->Form->control('im', ['label' => false, 'type' => 'text', 'maxlength' => '25', 'class' => $input]) ?>
                        </div>
                        <div class="<?= $double ?>">
                            <label class="<?= $label ?>"><?= __('Insc. Estadual') ?></label>
                ...
                <div class="<?= $double ?>">
                    ...
                    <?= $this->Form->control('email', ['label' => false, 'type' => 'text', 'class' => $input, 'maxlength' => '100', 'required' => false]) ?>
                </div>
            </div>
            ...
            <div class="<?= $single ?> well">
                <div class="<?= $double ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="<?= $double ?>">
                            <label class="<?= $label ?>"><?= __('Representante') ?></label>
                            <?= $this->Form->control('contato', ['label' => false, 'type' => 'text', 'maxlength' => '100', 'class' => $input]) ?>
                        </div>
                    </div>
                </div>
                <div class="<?= $double ?>">
