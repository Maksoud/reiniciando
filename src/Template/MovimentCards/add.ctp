...
/* MovimentCards */
/* File: src/Template/MovimentCards/add.ctp */
?>
            ...
            <div class="<?= $double ?> well" style="min-height: 262px;">
                <div class="row top-10">
                    ...
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('vencimento', ['label' => false, 'autocomplete' => 'off', 'type' => 'text', 'id' => 'vencimento', 'class' => $input.' datepicker datemask', 'placeholder' => __('Ex. 01/01/2020'), 'disabled']) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $single ?>">
                ...
                <div class="row">
                    ...
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                            ...
                            <i class="fa fa-info-circle" data-toggle="tooltip" title="<?= __('Estorno de pagamento ou crédito de variação cambial, deverão ser incluídos como receita. Demais compras deverão ser marcadas como despesas.') ?>"></i>
                        </label>
                        <div class="row box text-center" style="padding-top:0px; padding-bottom:0px; display:block; margin:auto; width:205px; height:35px; margin-top:0px; margin-bottom:4px; margin-left:-13px;">
