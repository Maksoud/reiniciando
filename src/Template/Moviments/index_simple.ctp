...
/* Moviments */
/* File: src/Template/Moviments/index_simple.ctp */
?>

<div class="col-xs-12 col-md-12 col-sm-12 container top-20">
    
    <div class="col-xs-12 panel" style="float: none;">
        <div class="pull-right"><?= $this->Html->link(__(' Incluir'), ['controller' => 'Moviments', 'action' => 'add_simple'], ['class' => 'btn btn-primary fa fa-plus-circle top-20 right-10 btn_modal', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Nova Conta a Pagar/Receber'), 'escape' => false]) ?></div>
            ...
            <tbody>
                <?php foreach($moviments as $moviment): ?>
                    <tr class="initialism">
                        ...
                        <td class="text-left"><?= $moviment->costs_id ? $moviment->Costs['title'] : '-'  ?></td>
                        ...
                        <td class="btn-actions-group">
                            ...
                            <?= $this->Html->link('', ['action' => 'edit_simple', $moviment->id], ['class' => 'btn btn-actions btn_modal fa fa-pencil edit', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Editar Cadastro'), 'title' => __('Editar'), 'escape' => false]) ?>
                            <?php }//if (empty($moviment->cards_id) && empty($moviment->plannings_id)) ?>
                            <?php if (!empty($moviment->cards_id) && $moviment->valor == 0 || empty($moviment->cards_id)) { 
                                ...
                                <?php }//if (empty($moviment->plannings_id))
                                }//if (!empty($moviment->cards_id) && $moviment->valor == 0 || empty($moviment->cards_id)) ?>
                            <?php } elseif ($moviment->status == 'B') { ?>
                            <?= $this->Html->link('', ['action' => 'view_simple', $moviment->id], ['class' => 'btn btn-actions btn_modal fa fa-eye', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Dados do Cadastro'), 'title' => __('Visualizar'), 'escape' => false]) ?>
                            <?= $this->Html->link('', ['action' => 'edit_baixado_simple', $moviment->id], ['class' => 'btn btn-actions btn_modal fa fa-pencil edit', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Editar Cadastro'), 'title' => __('Editar'), 'escape' => false]) ?>
