...
/* Moviments */
/* File: src/Template/Moviments/view_simple.ctp */
?>
                        ...
                        if ($moviment->status == 'G') {
                            ...
                            foreach ($movimentMergeds as $merged): 
                                if ($merged->Moviment_Mergeds['status'] == 'V') {
                                    ...
                                    }//else if ($merged->Moviment_Mergeds['status'] == 'B')
                                }//if ($merged->Moviment_Mergeds['status'] == 'V')
                            endforeach;
                        ...
                        foreach ($movimentos as $movimento): 
                            foreach($movimento as $value):
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?= $this->Html->link(str_pad($value->ordem, 6, '0', STR_PAD_LEFT), ['controller' => $controller, 'action' => 'view_simple', $value->id], ['class' => 'btn_modal2 label label-primary', 'data-title' => __('Visualizar Lançamento'), 'data-toggle' => 'modal', 'data-target' => '#myModal2']); ?></td>
                        ...
                        <?php 
                            ...
                            foreach ($movimentMergeds as $merged): 
                                ...
                                if ($merged->Moviment_Mergeds['status'] == 'V') {
                                    ?>
                                    <tr>
                                        <td class="text-left"><?= $this->Html->link(str_pad($merged->Moviment_Mergeds['ordem'], 6, '0', STR_PAD_LEFT), ['action' => 'view_simple', $merged->Moviment_Mergeds['id']], ['class' => 'btn_modal2 label label-primary', 'data-title' => __('Visualizar Lançamento'), 'data-toggle' => 'modal', 'data-target' => '#myModal2']); ?></td>
                    ...
                    <table class="table no-margin table-striped">
                        ...
                        <?php 
                            ...
                            foreach (array($moviments_main) as $merged): ?>
                                <tr>
                                    <td class="text-left"><?= $this->Html->link(str_pad($merged['ordem'], 6, '0', STR_PAD_LEFT), ['action' => 'view_simple', $merged['id']], ['class' => 'btn_modal2 label label-primary', 'data-title' => __('Visualizar Lançamento'), 'data-toggle' => 'modal', 'data-target' => '#myModal2']); ?></td>
                    ...
                    <table class="table no-margin table-striped">
                        ...
                        <?php 
                            ...
                            foreach ($movimentCards as $movimentCard): ?>
                                <tr>
                                    <td class="col-xs-1 text-left"><?= $this->Html->link(str_pad($movimentCard->ordem, 6, '0', STR_PAD_LEFT), ['controller' => 'MovimentCards', 'action' => 'view_simple', $movimentCard->id], ['class' => 'btn_modal2 label label-primary', 'data-title' => __('Visualizar Lançamento'), 'data-toggle' => 'modal', 'data-target' => '#myModal2']); ?></td>
