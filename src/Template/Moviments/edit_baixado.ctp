...
/* Moviments */
/* File: src/Template/Moviments/edit_baixado.ctp */
?>
            ...
            <div class="<?= $double ?> well" style="min-height: 230px;">
                <div class="row">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('valor', ['label' => false, 'type' => 'text', 'class' => $input.' valuemask', 'value' => $this->MyForm->decimal($moviment['valor']), 'placeholder' => __('0,00'), 'disabled' => true]) ?>
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input id="document_types_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Ex. Fatura') ?>" required="true" value="<?= $moviment->DocumentTypes['title'] ?>"><div class="loadingDocuments"></div>
                        </div>
                ...
                <div class="row">
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                            ...
                            <i class="fa fa-info-circle" data-toggle="tooltip" title="<?= __('Data em que o lançamento foi pago.') ?>"></i>
                        </label>
                    ...
                    <div class="<?= $double ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input id="event_types_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Ex. Dinheiro') ?>" required="true" value="<?= $moviment->EventTypes['title'] ?>"><div class="loadingEvents"></div>
                        </div>
                        <input name="event_types_id" id="event_types_id" type="hidden" value="<?= $moviment->EventTypes['id'] ?>">
                    </div>
                </div>
            </div>
