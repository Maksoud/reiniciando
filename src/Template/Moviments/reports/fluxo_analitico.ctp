...
<div class="col-xs-12 main">
    ...
    <h4 class="page-header text-bold"><?= __('DESPESAS E RECEITAS - FLUXO DIÁRIO - ANALÍTICO') ?></h4>
            ...
            if (!empty($vencimento)) {
                foreach (array_unique($vencimento) as $index => $values):
                    ...
                    <table class="col-xs-12 table table-striped table-condensed prt-report">
                            ...
                            foreach ($moviments as $value):
                                if ($value['vencimento'] == $vencimento[$index]) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left text-nowrap col-xs-1"><?= $value['documento'] ?></td>
                        ...
                        <tfoot>
                            <tr class="bg-blue">
                                <th colspan="8"><?= __('Totais dos Vencimentos do dia ').date("d/m/Y", strtotime($values)) ?></th>
