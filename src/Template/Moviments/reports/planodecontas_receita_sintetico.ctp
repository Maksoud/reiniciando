...
<div class="col-xs-12 main">
    ...
    <h4 class="page-header text-bold"><?= __('RECEITAS - POR PLANO DE CONTAS - SINTÉTICO') ?></h4>
                                ...
                                <tr>
                                    ...
                                    <?php
                                        foreach ($moviments as $moviment): 
                                            ...
                                            if ($moviment['account_plans_id'] == $accountPlan_id[$index] && $moviment['creditodebito'] == 'C') {
                                                $saldo += $moviment['valor'] - $valorpago;
                                                if (isset($moviment['valorbaixa'])) {
                                                    $saldod += $moviment['valorbaixa'] - ($moviment['valor'] - $valorpago);
                                                    $saldob += $moviment['valorbaixa'];
                                                }
                                            }
                                        endforeach;
                                    ?>
