...
<div class="col-xs-12 main bottom-50">
    ...
    <h4 class="page-header"><span class="text-bold"><?= __('FLUXO DE CAIXA - SINTÉTICO - POR CATEGORIAS') ?></span></h4>
    ...
    //debug($costs->toArray()); // EM DESENVOLVIMENTO 31/01/2018
    ...
    foreach ($costs as $cost):
                        ...
                        if (empty($value->dtbaixa)) { //SOMENTE TÍTULOS NÃO PAGOS
                            ...
                            if ($this->request->data['creditodebito'] == 'C') { //SOMENTE CRÉDITOS
                                ...
                                if (!empty($reg_sp[$indice])) {
                                    ...
                                    if ($value->creditodebito == 'C') {
                                        $reg_sp[$indice]['credito'] = $value->valor;
                                        $reg_sp[$indice]['debito']  = 0;
                                    } elseif ($value->creditodebito == 'D') {
                                        $reg_sp[$indice]['credito'] = 0;
                                        $reg_sp[$indice]['debito']  = $value->valor;
                                    }
                                }
        ...
        if (!empty($reg)) {
            ...
            <div><span class="text-bold"><?= $cost->title ?></span></div>
            <div class="col-xs-12 no-padding-lat table-responsive">
                <table class="table table-striped table-condensed prt-report">
                    ...
                    <tfoot>
                        <tr class="bg-blue">
                            <th class="text-left text-nowrap col-xs-1"><?= $cost->title ?></th>
    ...
    endforeach; //foreach ($plans as $cost)
    ...
    if (!empty($reg_sp)) {
        ...
        <div><span class="text-bold"><?= __('REGISTROS SEM PLANO DE CONTAS') ?></span></div>
        <div class="col-xs-12 no-padding-lat table-responsive">
            <table class="table table-striped table-condensed prt-report">
                <thead>
                    <tr class="bg-blue">
                ...
                <tfoot>
                    <tr class="bg-blue">
                        <th class="text-left text-nowrap col-xs-1"><?= __('REGISTROS SEM PLANO DE CONTAS') ?></th>
                        <th class="text-right text-nowrap col-xs-1"><?= $this->Number->currency($total_credito, 'BRL'); ?></th>
                        <th class="text-right text-nowrap col-xs-1"><?= $this->Number->currency($total_debito, 'BRL'); ?></th>
                        <th class="text-right text-nowrap col-xs-1"><?= $this->Number->currency($saldo, 'BRL'); ?></th>
                    </tr>
    ...
    if (isset($some_reg)) {
        ...
        <?php
        echo '*Valores de títulos baixados consideram o desconto.';
