...
<div class="col-xs-12 main bottom-50">
    ...
    <h3 class="page-header"><span class="text-bold"><?= __('FLUXO DE CAIXA - ANALÍTICO') ?></span></h3>
        ...
        foreach ($reg as $index => $value):
            ...
            <div class="col-xs-12 no-padding-lat table-responsive">
                <table class="table table-striped table-condensed prt-report">
                    <div><span class="text-bold"><?= __('Lançamentos do dia ') . date("d/m/Y", strtotime($index)) ?></span></div>
                    <thead>
                        <tr class="bg-blue">
                            ...
                            <th class="text-left text-nowrap col-xs-1"><?= __('Status') ?></th>
                            <th class="text-left text-nowrap col-xs-1"><?= __('Vencimento') ?></th>
                            <th class="text-left text-nowrap col-xs-1"><?= __('Pagamento') ?></th>
                            <th class="text-left text-nowrap col-xs-1"><?= __('Plano de Contas') ?></th>
                    ...
                    <tfoot>
                        <tr class="bg-blue">
                            <th colspan="10" class="text-left text-nowrap col-xs-1"></th>
                            <?php if ($this->request->data['creditodebito'] != 'D') { //SOMENTE CRÉDITOS ?>
