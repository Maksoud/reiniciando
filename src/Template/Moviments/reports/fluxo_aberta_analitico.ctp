...
<div class="col-xs-12 main">
    ...
    <h4 class="page-header text-bold"><?= __('DESPESAS E RECEITAS - EM ABERTO - FLUXO DIÁRIO - ANALÍTICO') ?></h4>
        ...
        ?>
            ...
            ?>        
                    <table class="col-xs-12 table table-striped table-condensed prt-report">
                        ...
                        <tfoot>
                            <tr class="bg-blue">
                                <th colspan="6"><?= __('Totais dos Vencimentos do dia ').date("d/m/Y", strtotime($values)) ?></th>
