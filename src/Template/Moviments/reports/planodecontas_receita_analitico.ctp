...
<div class="col-xs-12 main">
    ...
    <h4 class="page-header text-bold"><?= __('RECEITAS - POR PLANO DE CONTAS - ANALÍTICO') ?></h4>
                    ...
                    <table class="col-xs-12 table table-striped table-condensed prt-report">
                        ...
                        <tbody>    
                            ...
                            foreach ($moviments as $value):
                                if ($value['account_plans_id'] == $accountPlan_id[$index] && $value['creditodebito'] == 'C') {
                                    ?>
                                    <tr>
                                        ...
                                        <?php 
                                            if ($value['valorbaixa']) {
                                                echo $this->Number->currency($value['valorbaixa'],'BRL'); $saldob += $value['valorbaixa']; 
                                            }
                                        ?>
                                        </td>
                                    </tr>
                        ...
                        <tfoot>
                            <tr class="bg-blue">
                                <th colspan="7"><?= $accountPlan_title[$index] ?></th>
