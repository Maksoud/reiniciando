...
<div class="col-xs-12 main bottom-50">
    ...
    <h4 class="page-header text-bold"><?= __('FLUXO DE CAIXA - SINTÉTICO - POR PLANO DE CONTAS') ?></h4>
    ...
    //debug($plans->toArray()); // EM DESENVOLVIMENTO 31/01/2018
    
    foreach ($plans as $account_plan):
...
//        }
        ...
        if (!empty($moviments)) {
            ...
            foreach ($moviments as $value):
                ...
                if ($value->creditodebito == 'C' || $value->creditodebito == 'D') {
                    ...
                    if ($account_plan->id == $value->account_plans_id) {
            ...
            foreach ($moviments as $value):
                ...
                if ($value->creditodebito == 'C' || $value->creditodebito == 'D') {
                    ...
                    if (empty($value->account_plans_id)) {
        ...
        if (!empty($reg)) {
            ...
            <div><?= $account_plan->classification . ' - ' . $account_plan->title ?></div>
            <div class="col-xs-12 no-padding-lat table-responsive">
                <table class="table table-striped table-condensed prt-report">
                    ...
                    <tfoot>
                        <tr class="bg-blue">
                            <th class="text-left text-nowrap col-xs-1"><?= $account_plan->classification . ' - ' . $account_plan->title ?></th>
    ...
    endforeach; //foreach ($plans as $account_plan)
    ...
    if (!empty($reg_sp)) {
        ...
        <div class="text-bold"><?= __('REGISTROS SEM PLANO DE CONTAS') ?></div>
        <div class="col-xs-12 no-padding-lat table-responsive">
            <table class="table table-striped table-condensed prt-report">
                <thead>
                    <tr class="bg-blue">
