...
<div class="col-xs-12 main">
    ...
    <h4 class="page-header text-bold"><?= __('RECEITAS A RECEBER - FLUXO DIÁRIO - ANALÍTICO') ?></h4>
        ...
        ?>
            ...
            ?>        
                    <table class="col-xs-12 table table-striped table-condensed prt-report">
                        <div class="text-bold"><?= 'Vencimentos do dia '.date("d/m/Y", strtotime($values)) ?></div>
                        <thead>
                            <tr class="bg-blue">
                        ...
                        <tfoot>
                            <tr class="bg-blue">
                                <th colspan="6"><?= 'Totais dos Vencimentos do dia '.date("d/m/Y", strtotime($values)) ?></th>
            ...
            <table class="col-xs-12 table table-striped table-condensed prt-report">
                <thead>
                    <tr class="bg-blue">
                        <th colspan="5"></th>
                        <th class="text-right text-nowrap col-xs-1">Títulos</th>
                </thead>
                <tfoot>
                    <tr class="bg-blue">
                        <th colspan="5">SALDO TOTAL GERAL</th>
