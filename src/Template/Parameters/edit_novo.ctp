...
/* Parameters */
/* File: src/Template/Parameters/edit_novo.ctp */
?>
            ...
            <div class="<?= $double ?> box" style="height:313px;">
                <div class="row">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('tipo', ['label' => false, 'type' => 'select', 'class' => $input . ' tipocpfcnpj', 'options' => ['J' => 'Jurídica', 
                                                                                                                                                  'F' => 'Física'
                                                                                                                                                  ]]) ?>
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>"><?= __('CPF/CNPJ') ?>*</label>
                        <?= $this->Form->control('cpfcnpj', ['label' => false, 'type' => 'text', 'class' => $input . ' focus cpfcnpjmask validacpfcnpj']) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $single ?>">
                        <label class="<?= $label ?>"><?= __('Nome/Razão Social') ?>*</label>
                        <?= $this->Form->control('razao', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $double ?>">
