...
/* Parameters */
/* File: src/Template/Parameters/edit.ctp */
?>
            ...
            <div class="<?= $double ?> box" style="height:313px;">
                <div class="row">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('tipo', ['label' => false, 'type' => 'select', 'class' => $input.' tipocpfcnpj', 'disabled' => true, 'options' => ['J' => 'Jurídica', 'F' => 'Física']]) ?>
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>"><?= __('CPF/CNPJ') ?>*</label>
                        <?= $this->Form->control('cpfcnpj', ['label' => false, 'type' => 'text', 'class' => $input.' focus cpfcnpjmask validacpfcnpj', 'disabled' => true]) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $single ?>">
                        <label class="<?= $label ?>"><?= __('Nome/Razão Social') ?>*</label>
                        <?= $this->Form->control('razao', ['label' => false, 'type' => 'text', 'class' => $input, 'disabled' => true]) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $double ?>">
            ...
            <div class="<?= $double ?> well" style="height:313px;">
                <div class="row bottom-10">
                    <div class="<?= $single ?>">
                        ...
                        <?= $this->Form->file('logomarca', ['label' => ['text' => 'Logotipo', 'class' => $label.' file-custom', 'type' => 'image']]) ?>
                    </div>
                </div>
                <div class="row">
                    <div class="<?= $single ?>">
