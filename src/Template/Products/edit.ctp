...
/* Products */
/* File: src/Template/Products/edit.ctp */
?>
            ...
            <div class="<?= $double ?> box" style="min-height: 188px;">
                ...
                <div class="row">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('minimum', ['label' => false, 'type' => 'number', 'class' => $input]) ?>
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                            <?= __('Estoque Máximo') ?>
                        </label>
                        <?= $this->Form->control('maximum', ['label' => false, 'type' => 'number', 'class' => $input]) ?>
                    </div>
                </div>
            </div>
                ...
                <div class="row top-10">
                    <div class="<?= $double ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input id="types_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o tipo ou adicione') ?>" value="<?= $product->ProductTypes['title']?>"><div class="loadingProductTypes"></div>
                        </div>
                        <input name="product_types_id" id="product_types_id" type="hidden" value="<?= $product->product_types_id ?>">
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                            <?= __('Grupos') ?>
                        ...
                        <div class="input-group">
                            ...
                            <input id="groups_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o grupo ou adicione') ?>" value="<?= $product->ProductGroups['title']?>"><div class="loadingProductGroups"></div>
                        </div>
                        <input name="product_groups_id" id="product_groups_id" type="hidden" value="<?= $product->product_groups_id ?>">
                    </div>
                </div>
            </div>
                                    ...
                                    <?php foreach ($productTitles as $productTitle): ?>
                                        <tr style="font-size: 11px;">
                                            <td class="text-left" style="vertical-align:middle !important;">
                                                <input type="hidden" name="ProductList[<?= $productTitle->code ?>][products_code]" id="list_code" value="<?= $productTitle->code ?>">
                                                <?= $productTitle->code ?>
                                            </td>
                                            <td class="text-left text-nowrap" style="vertical-align:middle !important;">
                                                <input type="hidden" name="ProductList[<?= $productTitle->code ?>][products_title]" id="list_title" value="<?= $productTitle->title ?>">
                                                <?= $productTitle->title ?>
                                            </td>
                                            <td class="text-left" style="vertical-align:middle !important;">
                                                <input type="hidden" name="ProductList[<?= $productTitle->code ?>][products_obs]" id="list_obs" value="<?= $productTitle->obs ?>">
                                                <?= $productTitle->obs ?>
                                            </td>
