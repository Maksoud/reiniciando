...
/* PurchaseRequests */
/* File: src/Template/PurchaseRequests/add.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create('purchaseRequests', ['type' => 'file', 'class' => 'ajax_add', 'data-url' => 'purchaseRequests/addjson']) ?>
                                ...
                                <div class="<?= $double ?>">
                                    <div class="row">
                                        ...
                                        <div class="<?= $quad ?> no-padding-lat">
                                            ...
                                            <?= $this->Form->control('deadline', ['label' => false, 'autocomplete' => 'off', 'type' => 'text', 'value' => date('d/m/Y'), 'class' => $input . ' width-90 datepicker datemask controldate', 'placeholder' => __('Ex. 01/01/2020'), 'id' => 'edt_deadline']) ?>
                                        </div>
