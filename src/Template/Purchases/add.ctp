...
/* Purchases */
/* File: src/Template/Purchases/add.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create('purchase', ['type' => 'file', 'class' => 'ajax_add', 'data-url' => 'purchases/addjson']) ?>
                            ...
                            <tbody class="bg-gray">
                                <tr>
                                    ...
                                    <th class="text-right">
                                        ...
                                        <input type="hidden" name="totalquantity" id="totalquantity" value="0.00">
