...
/* Plannings */
/* File: src/Template/Plannings/index.ctp */
?>

<div class="col-xs-12 col-md-12 col-sm-12 container top-20">
    
    <div class="col-xs-12 panel" style="float: none;">
        <div class="pull-right"><?= $this->Html->link(__(' Incluir'), ['controller' => 'Plannings', 'action' => 'add'], ['class' => 'btn btn-primary fa fa-plus-circle top-20 right-10 btn_modal', 'data-loading-text' => __('Carregando...'), 'data-title' => 'Novo Planejamento/Meta', 'escape' => false]) ?></div>
                ...
                foreach ($plannings as $planning):
                    ...
                    <tr class="initialism">
                        ...
                        <td class="btn-actions-group">
                            <?= $this->Html->link('', ['action' => 'view', $planning->id], ['class' => 'btn btn-actions btn_modal fa fa-eye', 'data-loading-text' => __('Carregando...'), 'data-title' => __('Dados do Cadastro'), 'title' => __('Visualizar'), 'escape' => false]) ?>
