...
/* Plannings */
/* File: src/Template/Plannings/add_simple.ctp */
?>
            ...
            <div class="<?= $double ?> well" style="min-height: 258px;">
                <div class="row top-10">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('parcelas', ['label' => false, 'type' => 'number', 'id' => 'parcelas', 'class' => $input, 'value' => 1]) ?>
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                            <?= __('Periodicidade') ?>
                ...
                <div class="row pull-right-md">
                    <div class="<?= $single ?> top-10 bottom-10 text-right font-20" style="display: inline; font-weight: bolder;">
