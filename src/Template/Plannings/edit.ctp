...
/* Plannings */
/* File: src/Template/Plannings/edit.ctp */
?>
                ...
                <div class="row">
                    ...
                    <div class="<?= $single ?> C">
                        ...
                        <div class="input-group">
                            ...
                            <input id="customers_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o nome do cliente ou adicione') ?>" value="<?= $movimentCard->Customers['title'].' ('.$movimentCard->Customers['cpfcnpj'].')' ?>"><div class="loadingCustomers"></div>
                        </div>
                    ...
                    <div class="<?= $single ?> D hidden">
                        ...
                        <div class="input-group">
                            ...
                            <input id="providers_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o nome do fornecedor ou adicione') ?>" value="<?= $movimentCard->Providers['title'].' ('.$movimentCard->Providers['cpfcnpj'].')' ?>"><div class="loadingProviders"></div>
                        </div>
                ...
                <div class="row">
                    <div class="<?= $single ?>">
                        ...
                        <div class="input-group">
                            ...
                            <input id="costs_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o nome do centro de custos ou adicione') ?>" value="<?= $planning->Costs['title'] ?>"><div class="loadingCosts"></div>
                        </div>
                        <input name="costs_id" id="costs_id" type="hidden" value="<?= $planning->Costs['id'] ?>">
                    </div>
                    <div class="<?= $single ?>">
                        <label class="<?= $label ?>">
                            <?= __('Plano de Contas') ?>
                        ...
                        <div class="input-group">
                            ...
                            <input id="account_plans_title" class="form-control input-border-right" type="text" autocomplete="off" placeholder="<?= __('Digite o nome do plano de contas ou adicione') ?>" value="<?= $planning->AccountPlans['classification'] ?> - <?= $planning->AccountPlans['title'] ?>"><div class="loadingAccounts"></div>
                        </div>
                        <input name="account_plans_id" id="account_plans_id" type="hidden" value="<?= $planning->AccountPlans['id'] ?>">
                    </div>
                </div>
            </div>
            <div class="<?= $single ?>">
