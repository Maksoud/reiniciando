...
/* Plannings */
/* File: src/Template/Plannings/view.ctp */
?>
...
<div class="container-fluid">
    <div class="col-md-9 col-xs-12">
        ...
        <div class="col-md-12 panel-group box">
            <?php if (isset($planning->providers_id)) { ?>
            <div class="form-group borderRowBottom">
                <label><?= __('Fornecedor') ?></label><br>
                <?= h($planning->Providers['title']) ?>
            </div>
            <?php } ?>
            <?php if (isset($planning->customers_id)) { ?>
            <div class="form-group borderRowBottom">
                <label><?= __('Cliente') ?></label><br>
                <?= h($planning->Customers['title']) ?>
            </div>
            <?php } ?>
    ...
    <div class="col-md-3 col-xs-12 initialism text-center top-0">
        <div class="row">
            ...
            <div class="form-group box bottom-5 bg-info">
                ...
                <span class="label label-primary documento"><?= h($planning->documento) ?></span>
            </div>
            <?php 
            }//if ($planning->documento) ?>
