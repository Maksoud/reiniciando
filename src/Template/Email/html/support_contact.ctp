                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    ...
                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                        Uma nova ocorrência de chamado de suporte foi identificada
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                ...
                                                                                <span style="color:#5F5F5F;line-height:160%;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:bolder;margin-top:0;margin-bottom:3px;text-align:left;">
                                                                                    Ordem: <?= str_pad($supportContact['ordem'], 6, '0', STR_PAD_LEFT) ?><br>
                                                                                    Assunto: <?= $supportContact['title'] ?><br>
                                                                                    Descrição: <?= $supportContact['descricao'] ?><br>
                                                                                    E-mail de resposta: <?= $supportContact['mail'] ?><br>
                                                                                    Solicitante: <?= $supportContact['username'] ?><br>
                                                                                    <?= !empty($supportContact['resposta']) ? 'Resposta: '.$supportContact['resposta'] : '' ?>
                                                                                </span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
