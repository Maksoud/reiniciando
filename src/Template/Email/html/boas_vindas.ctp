                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                                                                    Estamos aqui para te ajudar a organizar as suas finanças e 
                                                                                    tornar seus sonhos realidade.<br><br>
                                                                                    Caso você precise de alguma ajuda, não deixe de nos enviar um e-mail para: 
                                                                                    suporte@reiniciando.com.br 
                                                                                </h3>
                                                                                <br><br>
