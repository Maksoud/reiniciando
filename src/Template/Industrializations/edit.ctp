...
/* Industrializations */
/* File: src/Template/Industrializations/edit.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create($industrialization) ?>
        ...
        <div class="row">
            <div class="<?= $double ?> well" style="min-height: 188px;">
                <div class="row top-10">
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('code', ['label' => false, 'type' => 'text', 'maxlength' => '6', 'class' => $input . ' focus', 'value' => str_pad($industrialization->code, 6, '0', STR_PAD_LEFT), 'disabled' => true]) ?>
                    </div>
                    <div class="<?= $double ?>">
                        <label class="<?= $label ?>">
                ...
                <div class="row">
                    <div class="<?= $single ?>">
                        ...
                        <?= $this->Form->control('sells_id', ['label' => false, 'type' => 'select', 'class' => $input, 'options' => $sells, 'disabled' => true]) ?>
                    </div>
                </div>
            </div>
            ...
            <div class="<?= $single ?> well">
                <div class="row top-10">
                    ...
                    <div class="<?= $double ?>">
                        <div class="row">
                            <div class="<?= $double ?>">
                                ...
                                <?= $this->Form->control('fluido', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                            <div class="<?= $double ?>">
                                <label class="<?= $label ?>">
                                    <?= __('Certificado') ?>
                                ...
                                <?= $this->Form->control('certificado', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="<?= $double ?>">
                                ...
                                <?= $this->Form->control('temperatura', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                            <div class="<?= $double ?>">
                                <label class="<?= $label ?>">
                                    <?= __('Duração') ?>
                                ...
                                <?= $this->Form->control('duracao', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="<?= $single ?>">
                                ...
                                <?= $this->Form->control('instalacao', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="<?= $single ?>">
                                ...
                                <?= $this->Form->control('pintura', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('localEntrega', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                    </div>
                    ...
                    <div class="<?= $double ?>">
                        ...
                        <?= $this->Form->control('compraTerceiros', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                    </div>
                    ...
                    <div class="<?= $double ?>">
                        <div class="row">
                            <div class="<?= $triple ?>">
                                ...
                                <?= $this->Form->control('resinabq', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                            <div class="<?= $triple ?>">
                                <label class="<?= $label ?>">
                                    <?= __('Catalizador B.Q.') ?>
                                ...
                                <?= $this->Form->control('catalizadorbq', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                            <div class="<?= $triple ?>">
                                <label class="<?= $label ?>">
                                    <?= __('Espessura B.Q.') ?>
                                ...
                                <?= $this->Form->control('espessurabq', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="<?= $triple ?>">
                                ...
                                <?= $this->Form->control('resinare', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                            <div class="<?= $triple ?>">
                                <label class="<?= $label ?>">
                                    <?= __('Catalizador Ref.') ?>
                                ...
                                <?= $this->Form->control('catalizadorre', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                            <div class="<?= $triple ?>">
                                <label class="<?= $label ?>">
                                    <?= __('Espessura Ref.') ?>
                                ...
                                <?= $this->Form->control('espessurare', ['label' => false, 'type' => 'text', 'class' => $input]) ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="<?= $single ?> box">
                ...
                <table id="products-table" class="table table-hover table-bordered table-condensed table-striped" style="margin-bottom: -1px;">
                    ...
                    <tbody>
                        <?php foreach ($industrializationItems as $industrializationItem): ?>
                            <tr style="font-size: 11px;">
                                <td class="text-nowrap" style="vertical-align:middle !important;">
                                    <input type="hidden" name="ProductList[<?= $industrializationItem->products_id ?>][products_id]" id="list_products_id" value="<?= $industrializationItem->products_id ?>">
                                    <input type="hidden" name="ProductList[<?= $industrializationItem->products_id ?>][products_title]" id="list_product" value="<?= $industrializationItem->Products['title'] ?>">
                                    <?= $industrializationItem->products_id ?> - <?= $industrializationItem->Products['title'] ?>
                                </td>
                                <td class="text-center" style="vertical-align:middle !important;">
                                    <input type="hidden" name="ProductList[<?= $industrializationItem->products_id ?>][unity]" id="list_unity" value="<?= $industrializationItem->unity ?>">
                                    <?= $industrializationItem->unity ?>
                                </td>
                                <td class="text-center" style="vertical-align:middle !important;">
                                    <input type="hidden" name="ProductList[<?= $industrializationItem->products_id ?>][quantity]" id="list_quantity" value="<?= $this->Number->format($industrializationItem->quantity, ['places' => 4, 'pattern' => '####.0000', 'locale' => 'en_US']) ?>">
                                    <?= $this->Number->precision($industrializationItem->quantity, 4) ?>
                                </td>
                                <td rowspan="2" class="text-center bg-gray" style="padding:21px;">
                            ...
                            <tr style="font-size: 11px;">
                                <td colspan="3" class="text-right">
                                    <input type="textarea" name="ProductList[<?= $industrializationItem->products_id ?>][obs]" maxlength="300" class="form-control form-control" placeholder="Observações" id="list_obs" value="<?= h($industrializationItem->obs) ?>">
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
