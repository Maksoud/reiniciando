...
/* ProductGroups */
/* File: src/Template/ProductGroups/add.ctp */
?>

<?php $this->layout = 'ajax'; ?>
<?= $this->Form->create('productGroup', ['type' => 'file', 'class' => 'ajax_add', 'data-url' => 'product-groups/addjson']) ?>
            ...
            <div class="<?= $single ?> well">
                <div class="row">
                    <div class="<?= $single ?>">
                        ...
                        <?= $this->Form->control('code', ['label' => false, 'type' => 'text', 'id' => 'text', 'maxlength' => '6', 'class' => $input . ' focus', 'value' => str_pad($code, 6, '0', STR_PAD_LEFT), 'required' => true]) ?>
                    </div>
                    <div class="<?= $single ?>">
                        <label class="<?= $label ?>">
                            <?= __('Título') ?>
