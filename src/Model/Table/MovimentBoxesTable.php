...
class MovimentBoxesTable extends Table
{
...
//            ->notEmpty('contabil');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        //$rules->add($rules->existsIn(['moviments_id'], 'Moviments')); //Estava causando erro na baixa 05/02/2018
        //$rules->add($rules->existsIn(['moviment_checks_id'], 'MovimentChecks'));
